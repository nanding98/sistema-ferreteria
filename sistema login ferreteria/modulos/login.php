...
if(isset($enviar)){
	...
	if(mysqli_num_rows($q)>0){ //Si hay al menos un registro entonces..
		$r = mysqli_fetch_array($q); //..se asigna los registros a $r
	...
	<center>
		<form method="post" action="">
			<div class="centrar_login">
				...
				<div class="form-group">
					<button class="btn btn-submit" name="enviar" type="submit"></i> Ingresar</button>
				</div>
			</div>
		</form>
	</center> 
